<template>
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="card">
                    <img v-bind:src="products[0].image" alt="Hình ảnh sản phẩm" class="card-img-top" />
                    <div class="card-body">
                        <h3 class="card-title">{{ products[0].name }}</h3>
                        <p class="card-text">{{ products[0].description }}</p>
                        <p class="card-text">Giá: {{ products[0].price }} VND</p>
            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Giá: {{ products[1].price }} VND</p>
                        <button class="btn btn-success">Mua ngay</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Giá: {{ products[2].price }} VND</p>
                        <button class="btn btn-success">Mua ngay</button>
                    </div>
                </div>
            </div>
